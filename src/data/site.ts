export const packages = [
    { package: "Paket Small", price: "179", speed: "20 Mbps", devices: "3-5" },
    { package: "Paket Basic", price: "199", speed: "30 Mbps", devices: "4-7" },
    { package: "Paket Medium", price: "235", speed: "35 Mbps", devices: "5-8" },
    { package: "Paket Office", price: "285", speed: "45 Mbps", devices: "7-10" },
    { package: "Paket Soho", price: "345", speed: "65 Mbps", devices: "8-12" },
    { package: "Paket Enterprise", price: "645", speed: "100 Mbps", devices: "11-14" },
];

export const trustSignals = [
    {
        title: "Cek area via WhatsApp",
        description: "Kirim lokasi pemasangan ke WhatsApp resmi agar tim EONET mengecek ketersediaan area.",
    },
    {
        title: "Paket transparan",
        description: "Bandingkan kecepatan, harga, dan perangkat ideal sebelum memilih paket internet.",
    },
    {
        title: "Support lokal",
        description: "Tim EONET membantu konsultasi paket, cek area, dan tindak lanjut pemasangan.",
    },
    {
        title: "Konsultasi sebelum pasang",
